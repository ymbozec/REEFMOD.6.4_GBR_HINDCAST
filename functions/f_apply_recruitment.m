...
%     lambda = full(max_density_settlers(s) * turf_cm2./ REEF.floor_SA_cm2); % mean parameter of the poisson distribution of number of recruits
...
%     end
    ...
    list_new = coral(s).colony_ID(coral(s).colony_ID~=0); % do this befor ethe list of ID is extended with recruits
...
algal(1).cover_cm2 = sparse(EAM_cm2);
