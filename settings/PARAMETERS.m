...
% YM: follwoing Ken's suggestion, horizontal extension is the cosinus of 45
...
CORAL.size_mean = [log(700) ; log(700) ; log(500) ; log(700); log(700) ; log(1000) ]; %For GBRF
...
CORAL.size_var = [log(2^2) ; log(2^2) ; log(2^2) ; log(2^2) ; log(2^2) ; log(2^2)];  %For GBRF
...
% Adults (cm): 17 27 37 47 57 67 77 87 97 
...
CORAL.sensitivity_bleaching = 0.5*[1.5 ; 1.6 ; 1.4 ; 1.7 ; 0.25 ; 0.25]; % GBR after calibration with Hughes et al (2018)
% A multiplicator of the bleaching mortality probabilities (whole and partial colonies)
% Note: halved to account for reduction in bleaching with depth due to light attentation (Baird et al. 2018)
